...
**🔗 [View the live, interactive page](https://tariqfnz1-a11y.github.io/Edtech-Road-Map/edtech-roadmap-v2.html)**

No build step, no dependencies, no server required. You can also download `edtech-roadmap-v2.html` and open it directly in any modern browser.
...
**Option A — use it online:** just open the [live page](https://tariqfnz1-a11y.github.io/Edtech-Road-Map/edtech-roadmap-v2.html), hosted via GitHub Pages.

**Option B — run it locally:**
1. Download `edtech-roadmap-v2.html` from this repo.
